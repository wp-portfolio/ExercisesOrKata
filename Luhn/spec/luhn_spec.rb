...
RSpec.describe Luhn, type: :model do
  describe 'is_valid? should work' do
    ...
    it 'should return false if the number is not valid and the number has an odd number of digits' do
      expect(Luhn.is_valid?(123)).to be false
    end
    it 'should return false if the number is nil' do
      expect(Luhn.is_valid?(nil)).to be false
    end
    it 'should return false if the number is 0' do
      expect(Luhn.is_valid?(0)).to be false
    end
  end
end